        ...
        <div class="col-lg-9 col-md-8">
          ...
          <div class="pagination justify-content-center py-4">
            <nav aria-label="Page navigation example">
              <ul class="pagination">
                <li class="page-item">
                  <a class="page-link" href="ad-list-view2.php" aria-label="Previous">
                    <span aria-hidden="true">&laquo;</span>
                    <span class="sr-only">Previous</span>
                  </a>
                </li>
                <li class="page-item"><a class="page-link" href="ad-list-view2.php">1</a></li>
                <li class="page-item active"><a class="page-link" href="ad-list-view2.php">2</a></li>
                <li class="page-item"><a class="page-link" href="ad-list-view2.php">3</a></li>
                <li class="page-item">
                  <a class="page-link" href="ad-list-view2.php" aria-label="Next">
