...
// ID DEL REGISTRO DEL INVENTARIO
$id_inv = $_GET["id_inv"];
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  if ($form == "updateInv") {
    ...
    $entradas = $_POST["entradas_inv"];
    $salidas = $_POST["salidas_inv"];
    $stock = $_POST["stock_inv"];

    $objTblInventarioController->processUpdateInv($id_producto, $entradas, $salidas, $stock);
  }
}
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="card">
        <div class="card-body">
          <?php
          $objTblInventarioController->updateInv($id_inv);
          ?>
        </div>
      </div>
