...
require_once ('../../Controllers/Administrador/tablaVentas.php');
    ...
    buttons: [
      {
        extend: 'pdf',
        exportOptions: {
          columns: [0, 1, 2, 3, 4, 5, 6, 7] // Especifica las columnas que deseas incluir en el PDF
        },
        customize: function (doc) {
          // Personalización del documento PDF
          doc.content.splice(0, 1, {
            text: 'Informe de Ventas', // Cambia el título del documento PDF
            style: 'title'
          });
