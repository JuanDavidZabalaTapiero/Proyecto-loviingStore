...
require_once (__DIR__ . '/../../Controllers/Administrador/tablaPedidos.php');
$objTablaPedidos = new TablaPedidos();
?>
    ...
    buttons: [
      {
        extend: 'pdf',
        exportOptions: {
          columns: [0, 1, 2, 3, 4] // Especifica las columnas que deseas incluir en el PDF
        },
        customize: function (doc) {
          // Personalización del documento PDF
          doc.content.splice(0, 1, {
            text: 'Informe de Pedidos', // Cambia el título del documento PDF
            style: 'title'
          });
