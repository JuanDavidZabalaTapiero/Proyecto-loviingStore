        ...
        <div class="col-lg-12">
          ...
          <div class="card tabla-consultar">
            <div class="card-body tabla-consultar">
              <h5 class="card-title">Gestión proveedores</h5>
              <table id="TableSynchronize" class="table datatable">
                <thead>
                  <tr>                   
                    <th>Id</th>
                    <th>Nombre empresa</th>                  
                    <th>Nombre representante de ventas</th>
                    <th>Correo</th>
                    <th>Dirección</th>
                    <th>Teléfono</th>
                    <th>Editar</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Group cos</td>
                    <td>Pepe</td>
                    <td>gpepe@gmail.com</td>           
                    <td>Cl 38b sur 26d</td>
                    <td>777777777</td>
